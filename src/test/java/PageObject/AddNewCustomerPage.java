...
public class AddNewCustomerPage 
{
    ...
    WebElement txtItemAdministrators;
    ...
    public void clickOnCustomersMeniItem()
    {
    ...
    {
    	Select roles=new Select(txtCustomerRoles);
    ...
    public void enterMangerOfVender(String value)
    {
